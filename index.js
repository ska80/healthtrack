...
(function(exports) {
  ...
  var textInputU = React.unsafeCreateLeafElement($foreign.textInputClass);
...
(function(exports) {
  ...
  var ReactNative_PropTypes_Color = PS["ReactNative.PropTypes.Color"];
  var Unsafe_Coerce = PS["Unsafe.Coerce"];                    
  var paddingLeft = $foreign.unsafeStyleProp("paddingLeft");    
...
(function(exports) {
  ...
  var ReactNative_Unsafe_Components = PS["ReactNative.Unsafe.Components"];
  var Unsafe_Coerce = PS["Unsafe.Coerce"];
  var textInput$prime = function (dictOptional) {
      return function ($1) {
          return ReactNative_Unsafe_Components.textInputU(ReactNative_Unsafe_ApplyProps.unsafeApplyProps($1));
      };
  };
...
(function(exports) {
  ...
  var sheet = {
      container: ReactNative_Styles.staticStyles([ ReactNative_Styles.marginTop(64), ReactNative_Styles.padding(3), ReactNative_Styles.paddingLeft(8), ReactNative_Styles_Flex.alignItems(ReactNative_PropTypes.center(ReactNative_Styles_Flex.flexAlignmentCenter)) ]),
      textInput: ReactNative_Styles.staticStyles([ ReactNative_Styles_Text.fontSize(15), ReactNative_Styles.height(30) ])
  };
  var initialState = {
      nextId: 0,
      items: [  ],
      ...
      var $$eval = function (input) {
          if (input instanceof AddItem) {
              return Dispatcher_React.modifyState(Effect_Aff.monadEffectAff)(function (state) {
                  ...
                  $7.items = Data_Array.cons("item: " + state.input)(state.items);
                  $7.nextId = state.nextId + 1 | 0;
                  return $7;
              });
          };
          if (input instanceof InputChange) {
              return Dispatcher_React.modifyState(Effect_Aff.monadEffectAff)(function (state) {
                  var $10 = {};
                  for (var $11 in state) {
                  ...
                  $10.input = input.value0;
                  return $10;
              });
          };
          throw new Error("Failed pattern match at Main line 37, column 7 - line 45, column 47: " + [ input.constructor.name ]);
      };
      var spec = function ($$this) {
          var de = function ($18) {
              return Dispatcher.affAction($$this)($$eval($18));
          };
          var v = Dispatcher.mkDispatch1(de);
          var render = function (v1) {
              return ReactNative_Components_View.view_([ ReactNative_Components_TextInput["textInput'"](ReactNative_Optional.srInst())({
                  onChange: v(function ($19) {
                      return InputChange.create((function (v2) {
                          return v2.nativeEvent.text;
                      })($19));
                  }),
                  style: sheet.textInput,
                  placeholder: "Enter item to log..."
              }), ReactNative_Components_Button.button("Add Log Item")(v(Data_Function["const"](AddItem.value))), ReactNative_Components_ListView.listView(ReactNative_Components_ListView.listViewDataSource(v1.state.items))(ReactNative_Components_Text.text_) ]);
          };
